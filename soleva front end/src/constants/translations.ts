export const translations = {
  en: {
    ...
    shippingCostTo: "Shipping cost to",
    ...
    "Please upload your payment receipt in your orders page to verify your payment. Your order will be processed once payment is confirmed.": "Please upload your payment receipt in your orders page to verify your payment. Your order will be processed once payment is confirmed.",
    ...
    "Phone": "Phone",
    "Select an order to view details": "Select an order to view details",
  ...
  ar: {
    ...
    shippingCostTo: "تكلفة الشحن إلى",
    addressRequired: "يرجى إكمال جميع حقول العنوان",
    ...
    "Please upload your payment receipt in your orders page to verify your payment. Your order will be processed once payment is confirmed.": "يرجى رفع إيصال الدفع في صفحة طلباتك للتحقق من دفعتك. سيتم معالجة طلبك بمجرد تأكيد الدفع.",
    
    // Order Management - إدارة الطلبات
    "My Orders": "طلباتي",
    "No Orders Yet": "لا توجد طلبات بعد",
    "You haven't placed any orders yet. Start shopping to see your orders here!": "لم تقم بوضع أي طلبات بعد. ابدأ التسوق لترى طلباتك هنا!",
    ...
    "Phone": "الهاتف",
    "Select an order to view details": "اختر طلباً لعرض التفاصيل",
    "View Details": "عرض التفاصيل",
    "Payment": "الدفع",
    "Error Loading Orders": "خطأ في تحميل الطلبات",
    "Retry": "إعادة المحاولة",
    "Please login to view your orders": "يرجى تسجيل الدخول لعرض طلباتك"
  }
};